    ...
    test.each<Case>([
      ...
      [
        'valid running (17359450317)',
        {
          ...
          name: 'Having a morning of aerobic conditioning. 🏃‍♂️ The spring is close… 🌤️',
          distance: 9528.7,
          moving_time: 3585,
          ...
          total_photo_count: 1,
          description:
            '🤖 Adding an image generated by my AI service TORQ. Still not ideal, many things must be improved. Anyway, I’m pleased with the progress!',
          calories: 741,
          gear: {
            id: 'g14554890',
      ...
      [
        'valid yoga (17348009150)',
        {
          ...
          name: 'Calming down after a stressful day… 🧘‍♂️ Preparing my mind and body for sleep. 😴',
          distance: 0,
          moving_time: 1803,
      ...
      [
        'valid weight training (17303325722)',
        {
          ...
          name: 'Sadly skipping the running session due to extra slippery roads. 😕 Falling back the the kettlebells wright training. 🏋️ Trying to avoid accidents and save my body for the events season. 🏃‍➡️',
          distance: 0,
          moving_time: 2387,
          total_elevation_gain: 0,
          type: 'WeightTraining',
      ...
      [
        'valid walk (16861704067)',
        {
          ...
          name: 'Walking with a toddler during the snowstorm. ☃️  Just happy to have a snow around. 👏',
          distance: 2156,
          moving_time: 2808,
